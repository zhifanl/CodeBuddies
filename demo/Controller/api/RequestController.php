    ...
    public function listAction($uri)
    {
        ...
        if (strtoupper($requestMethod) == 'GET') {
            ...
            try {
                ...
                $arrRequestModel = $requestModel->getRequest($intLimit);
                $responseData = json_encode($arrRequestModel);
                // send output
                if (!$strErrorDesc) {
                    $this->sendOutput(
                        $responseData,
            ...
            try {
                ...
                $result=$requestModel->updateRequest($request_id,$email, $course_name,$client_name, $teacher_name, $course_name);
        ...
        // user/list?username=xxx
            ...
            try {
                ...
                $result=$requestModel->deleteRequest($request_id);// in fact the delete method does not have to have parameters
            ...
            try {
                ...
                $result=$requestModel->postRequest();
